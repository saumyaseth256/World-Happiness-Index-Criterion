...
As far as the scope of this project is concerned, I will take the data relating to the following factors in account and try to gather inferences through charts, graphs and other tools of data analysis.

- Mental health
- Crime

Through this project, I aim to examine the relation between the above mentioned factors and the happiness score.
